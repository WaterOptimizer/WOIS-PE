...
**     Contents  :
**         PutVal - void hwLcdRs_PutVal(bool Val);
**
...
/*
** ===================================================================
**     Method      :  hwLcdRs_PutVal (bean BitIO)
**
**     Description :
...
** ===================================================================
*/
void hwLcdRs_PutVal(bool Val)
{
  if (Val) {
    setReg8Bits(PTGD, 0x01);           /* PTGD0=0x01 */
  } else { /* !Val */
    clrReg8Bits(PTGD, 0x01);           /* PTGD0=0x00 */
  } /* !Val */
}
